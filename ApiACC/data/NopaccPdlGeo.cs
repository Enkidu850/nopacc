...
public partial class NopaccPdlGeo
{
    ...
    public virtual ICollection<NopaccPdlProdPrj> NopaccPdlProdPrjs { get; set; } = new List<NopaccPdlProdPrj>();

    public virtual ICollection<NopaccPdlSelectPrj> NopaccPdlSelectPrjs { get; set; } = new List<NopaccPdlSelectPrj>();
}
