...
public partial class PatrimonyBatiment
{
    ...
    public string? NumberOfFloorsPos { get; set; }

    public string? NumberOfFloorsNeg { get; set; }

    public double? AvailableHeightClearance { get; set; }

    public string? BuildingPabType { get; set; }

    public string? CategoryPab { get; set; }

    public string? NumLastBuildingPermit { get; set; }

    public string? DateLastBuildingPermit { get; set; }
    ...
    public string? ArchitecturalEnergyEfficiency { get; set; }

    public string? WinterComfort { get; set; }

    public string? SummerComfort { get; set; }
